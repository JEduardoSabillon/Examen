...
while True:
    ...
    print("3. Preguntar su renta anual")
    print("4. Pregunte al usuario su edad")
    print("5. Salir")
    print("")
...
#                          ------- EJERCICIO 7 EXAMEN --------
# Opción 3: Que pregunte al usuario la renta su renta anual y muestre por pantalla el tipo impositivo que le corresponde 
    elif opcion == "3":
        print("")
        renta = int(input("ingresa el consumo de tu renta: "))
        
 

#                          ------- EJERCICIO 17 EXAMEN --------        
# Opción 4: Pregunte al usuario su edad desde que nacio (desde 1 hasta la actualidad).  
    elif opcion == "4":
        print("")
...
# Opción 5: Sale del bucle y finaliza el programa.
    elif opcion == "5":
        print("Saliendo...")
        break
    else:
